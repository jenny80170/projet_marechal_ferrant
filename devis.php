...
<div class="flex-column col-md-9">
  <div class="flex-column col-md-9">
    ...
    <h1 class="title_peru d-flex justify-content-center mt-5 font-weight-bold">Demande de devis</h1>
    <p class="parameterP font-weight-bold">Vous voulez un devis ? demandez le via le formulaire ci-dessous</p>
