...
<html lang="fr" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="/views/assets/fullCalendar/core/main.css">
        <link rel="stylesheet" href="/views/assets/fullCalendar/daygrid/main.css">
        <link rel="stylesheet" href="/views/assets/fullCalendar/timegrid/main.css">
        <link rel="stylesheet" href="/views/assets/fullCalendar/list/main.css">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark parameterNavbar" id="navMenu">
                        ...
                        <div class="collapse navbar-collapse navPhone" id="navbarColor01">
                            <ul class="navbar-nav m-auto">
                                <li>
                                    <i id="phoneConnect" class="fa fa-user-circle-o iconConnect" aria-hidden="true"><a class="nav-link font-weight-bold text-dark connectPhone" href="index.php?index=connexion">Je me connecte</a></i>
                                </li>
                                ...
                                ?>
                                <li class="nav-item active">
                                    <a class="nav-link font-weight-bold text-dark" id="logout" href="index.php?index=logout">Se déconnecter</a>
                                </li>
                                <?php } ?>
                            </ul>
